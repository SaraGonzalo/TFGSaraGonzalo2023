...
/**
 * Clase que representa el Nivel 4 del juego de cálculo.
 * Extiende la clase base "JuegoCalculo".
 */
class CalculoNivelCuatro : JuegoCalculo() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this, "NIVEL 4: MULTIPLICACIONES", Toast.LENGTH_SHORT).show()
        imgOperacion.setImageResource(R.drawable.producto)
        aleatorio()
    }
    /**
    ...
    override fun aleatorio() {
        ...
        if (puntuacionCalculo < 40) {
            ...
            mp.stop()
            mp.release()
            val intent = Intent(this, CalculoNivelCinco::class.java)
