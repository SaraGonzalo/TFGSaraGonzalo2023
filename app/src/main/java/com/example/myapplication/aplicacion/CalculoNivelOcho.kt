...
/**
 * Clase que representa el Nivel 8 del juego de cálculo.
 * Extiende la clase base "JuegoCalculo".
 */
class CalculoNivelOcho : JuegoCalculo() {
    private var resultado: Int = 0
    /**
     * Método que se ejecuta al crear la actividad del nivel 8.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this, "NIVEL 8: RESTOS", Toast.LENGTH_SHORT).show()
        imgOperacion.setImageResource(R.drawable.resto)
        aleatorio()
    }
    /**
    ...
    override fun aleatorio() {
        ...
        if (puntuacionCalculo < 80) {
            ...
            mp.stop()
            mp.release()
            val intent = Intent(this, CalculoNivelNueve::class.java)
