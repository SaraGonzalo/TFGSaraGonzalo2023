...
/**
 * Clase que representa el Nivel 5 del juego de cálculo.
 * Extiende la clase base "JuegoCalculo".
 */
class CalculoNivelCinco : JuegoCalculo() {
    private var resultado: Int = 0
    private lateinit var operaciones: Array<String>
    /**
     * Método que se ejecuta al crear la actividad del nivel 5.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this, "NIVEL 5: SUMAS, RESTAS Y MULTIPLICACIONES", Toast.LENGTH_SHORT).show()
        operaciones = arrayOf("suma", "resta", "producto")
        aleatorio()
    }
    /**
    ...
    override fun aleatorio() {
        ...
        if (puntuacionCalculo < 50) {
            ...
            mp.stop()
            mp.release()
            val intent = Intent(this, CalculoNivelSeis::class.java)
